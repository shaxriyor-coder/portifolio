      ...
      <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6">
        <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between">
          ...
          <div className="flex-1">
            <h3 className="mb-4 font-bold">Portfolio</h3>
            <p className="text-sm text-muted-foreground">Building beautiful, functional web experiences with modern technology.</p>
          </div>
